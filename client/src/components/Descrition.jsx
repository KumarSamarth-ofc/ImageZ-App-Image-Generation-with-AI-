...
const Descrition = () => {
  return (
    ...
    >
      ...
      <p className="text-gray-500 mb-8 mt-2">Bring Creative Vision to Life</p>
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center ">
        <img
          src={assets.sample_img_2}
          alt=""
          className="rounded-lg hover:scale-110 hover:shadow-xl transition-transform duration-300"
        />
        <div>
